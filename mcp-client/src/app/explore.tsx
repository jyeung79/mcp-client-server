...
import { BottomTabInset, ClassNames, Spacing } from '@/constants/theme';
...
export default function TabTwoScreen() {
  ...
  return (
    <ScrollView
      ...
      <ThemedView className="w-full max-w-content flex-grow">
        <ThemedView className="items-center gap-4 px-6 py-16">
          <ThemedText type="subtitle">Explore</ThemedText>
          <ThemedText className={ClassNames.centerText} themeColor="textSecondary">
        ...
        <ThemedView className={ClassNames.sectionStack}>
